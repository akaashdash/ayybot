...
class Randomness:
    ...
    async def rand(self, ctx, limit: int):
        ...
        embed = discord.Embed(
            description=":small_orange_diamond:Randomly selected **{0}** from 1 to {1}.".format(result, limit), color=0xFFA500)
    ...
    async def roll(self, ctx):
        ...
        embed = discord.Embed(
            description=":small_orange_diamond:Rolled a die and got **{0}**.".format(result), color=0xFFA500)
        await self.bot.send_message(ctx.message.channel, embed=embed)
    ...
    async def choose(self, ctx, *choices: str):
        ...
        embed = discord.Embed(
            description=":small_orange_diamond:Chose **{0}**.".format(random.choice(choices)), color=0xFFA500)
        await self.bot.send_message(ctx.message.channel, embed=embed)
    ...
    async def r6attacker(self, ctx):
        ...
        embed = discord.Embed(
            description=":small_orange_diamond:**{0}** is your attacker.".format(random.choice(choices)), color=0xFFA500)
        await self.bot.send_message(ctx.message.channel, embed=embed)
    ...
    async def r6defender(self, ctx):
        ...
        embed = discord.Embed(
            description=":small_orange_diamond:**{0}** is your defender.".format(random.choice(choices)), color=0xFFA500)
        await self.bot.send_message(ctx.message.channel, embed=embed)
